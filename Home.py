...
with col1:
    ...
    st.page_link("pages/2_Dashboard.py", label="Zur Übersicht öffnen", query_params={"tab": "Übersicht"})
    ...
    st.page_link("pages/2_Dashboard.py", label="Zum Verletzungsvergleich öffnen", query_params={"tab": "Verletzungsvergleich"})
    
    st.divider()
    
    st.markdown("#### Zeit & Liga")
    st.write("Analyse von saisonalen Trends, monatlichen Mustern und der zeitlichen Entwicklung.")
    st.page_link("pages/2_Dashboard.py", label="Zu Zeit & Liga öffnen", query_params={"tab": "Zeit & Liga"})
    
    st.divider()
    
    st.markdown("#### Tabellen")
    st.write("Vollständige, filterbare Datenbank aller erfassten Verletzungsfälle für Detailanalysen.")
    st.page_link("pages/2_Dashboard.py", label="Zu den Tabellen öffnen", query_params={"tab": "Tabellen"})

with col2:
    st.markdown("#### Karten")
    st.write("Visualisierung der Verletzungshäufigkeit basierend auf der Spielerposition auf dem Spielfeld.")
    st.page_link("pages/2_Dashboard.py", label="Zu den Karten öffnen", query_params={"tab": "Karten"})
    
    st.divider()
    
    st.markdown("#### Bodymap")
    st.write("Anatomische Darstellung der am häufigsten betroffenen Körperregionen.")
    st.page_link("pages/2_Dashboard.py", label="Zur Bodymap öffnen", query_params={"tab": "Bodymap"})
    ...
    st.page_link("pages/2_Dashboard.py", label="Zu den DDDM Entscheidungen öffnen", query_params={"tab": "DDDM Entscheidungen"})
    ...
    st.page_link("pages/2_Dashboard.py", label="Zur Marktwert-Analyse öffnen", query_params={"tab": "Marktwert & Risiko-Analyse"})